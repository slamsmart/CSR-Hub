...
const ACTIVE_PROJECTS = [
  {
    id: "1", name: "Beasiswa SMA untuk 50 Pelajar Kurang Mampu",
    progress: 65, progressKeuangan: 58, startDate: "2025-01-01",
    endDate: "2025-12-31", nextMilestone: "Ujian Semester",
  },
];

const NOTIFICATIONS = [
  { id: "1", type: "success", message: "Proposal CSR-2025-11189 sedang dalam review admin." },
  { id: "2", type: "warning", message: "Proposal CSR-2025-11098 membutuhkan revisi. Cek pesan reviewer." },
  { id: "3", type: "info", message: "Laporan progres bulan Maret sudah dapat disubmit." },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="section-title">Dashboard Pengusul</h1>
          <p className="section-subtitle">Kelola proposal dan pantau proyek CSR Anda.</p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Total Proposal" value="4" icon={FileText} iconColor="text-brand-600" iconBg="bg-brand-50" />
        <StatCard title="Disetujui / Didanai" value="2" icon={CheckCircle2} iconColor="text-green-600" iconBg="bg-green-50" />
        <StatCard title="Dana Diterima" value="Rp 340jt" icon={DollarSign} iconColor="text-teal-600" iconBg="bg-teal-50" />
        <StatCard title="Penerima Manfaat" value="2.400" icon={Users} iconColor="text-blue-600" iconBg="bg-blue-50" />
      </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="text-right flex-shrink-0">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Diperbarui: {formatDate(p.updatedAt, "dd MMM yyyy")}
                    </p>
                    <Link href={`/pengusul/proposal/${p.id}`}>
              ...
              {ACTIVE_PROJECTS.map((project) => (
                <div key={project.id} className="space-y-3">
                  ...
                  <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span>Milestone berikutnya: <strong>{project.nextMilestone}</strong></span>
                  </div>
                </div>
              ))}
            </div>
